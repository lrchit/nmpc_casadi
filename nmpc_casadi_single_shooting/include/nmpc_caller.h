...
public:
  ...
  // 四阶龙格库塔法
  SX ode45(SX _state_vars, SX _control_vars, SX _p_feet);
  // 一阶欧拉法
  SX Eular_method(SX _state_vars, SX _control_vars, SX _p_feet);

  SX motion_function(SX _state_vars, SX _control_vars, SX _p_feet);
